...
CreateThread(function()
	...
	if Config.Locations[1].zoneEnable then	-- [[ Main Location ]] --
		...
		if loc.MLO == "NP" then
			propTable[#propTable+1] = { prop = "prop_food_bs_tray_02", coords = vec4(-1192.92, -882.71, 14.43, 317.5) }
			propTable[#propTable+1] = { prop = "prop_food_bs_tray_01", coords = vec4(-1190.79, -886.38, 13.89, 303.67) }
			propTable[#propTable+1] = { prop = "prop_food_bs_tray_01", coords = vec4(-1190.79, -886.38, 13.89, 303.67) }

			propTable[#propTable+1] = { prop = "prop_food_bs_bag_04", coords = vec4(-1190.79, -886.38, 13.89, 303.67) }
			propTable[#propTable+1] = { prop = "prop_food_bs_bag_04", coords = vec4(-1190.79, -886.38, 13.89, 303.67) }
			propTable[#propTable+1] = { prop = "prop_food_bs_bag_04", coords = vec4(-1190.79, -886.38, 13.89, 303.67) }
...
RegisterNetEvent('jim-burgershot:washHands', function(data)
    QBCore.Functions.Progressbar("washing_hands", Loc[Config.Lan].progressbar["washing_hands"], 1000, false, true, {
...
RegisterNetEvent('jim-burgershot:client:GrabBag', function(data)
    QBCore.Functions.Progressbar("grab_murder_bag", Loc[Config.Lan].progressbar["grab_murder_bag"], 2000, false, true, {
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
RegisterNetEvent('jim-burgershot:Crafting:MakeItem', function(data)
	...
	local animation = { dict = animDictNow, anim = animNow, flag = 49 }
    ...
    QBCore.Functions.Progressbar(data.item, bartext, bartime, false, true, disableControls, animation, {}, {}, function()
        CraftLock = false
...
RegisterNetEvent('jim-burgershot:client:Consume', function(itemName, type)
    ...
    QBCore.Functions.Progressbar(itemName, progstring..QBCore.Shared.Items[itemName].label.."..", math.random(1000, 3000), false, true, {
        disableMovement = false,
        disableCarMovement = false,
        disableMouse = false,
        disableCombat = true,
