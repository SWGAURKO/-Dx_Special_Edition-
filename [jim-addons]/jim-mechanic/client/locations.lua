...
-- GABZ LS TUNER SHOP --
    {    job = "mechanic3",
        ...
        stash = {
            { coords = vector4(133.51, -3017.36, 7.04, 4.9), w = 2.6, d = 3.6, }, 
            { coords = vector4(124.94, -3049.93, 7.04, 178.0), w = 2.6, d = 3.5, },
        },
        store = { { coords = vector4(123.79, -3047.05, 7.04, 92.56), w = 2.6, d = 3.0, }, 
                  {    coords = vector4(128.76, -3017.19, 7.04, 355.56), w = 2.6, d = 3.0, },
        },
        crafting = { { coords = vector4(127.48, -3040.36, 7.04, 185.99), w = 2.6, d = 3.0, },
                     { coords = vector4(124.11, -3031.08, 7.04, 92.27), w = 2.6, d = 3.0, },
                     { coords = vector4(127.47, -3021.55, 7.04, 356.87), w = 2.6, d = 3.0, },
                     { coords = vector4(139.44, -3018.59, 7.04, 85.59), w = 2.6, d = 3.0, },  
        },
        clockin = {
        ...
        nosrefill = { { coords = vector4(136.15, -3018.61, 7.04, 275.19) } },
