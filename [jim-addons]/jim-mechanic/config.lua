...
--DuctTape Controllers
	...
	JobRoles = { "mechanic", "mechanic2", "mechanic3", "mechanic4", "mechanic5", "mechanic6", "mechanic7", "mechanic8" }, -- These are the job roles who can use items if RequiresJob is enabled.
