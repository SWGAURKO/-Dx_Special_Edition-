...
--Mining Store Items
	Items = {
		...
		items = {
			{ name = "water_bottle", price = 35, amount = 100, info = {}, type = "item", slot = 1, },
			{ name = "sandwich", price = 55, amount = 250, info = {}, type = "item", slot = 2, },
			{ name = "bandage", price = 75, amount = 100, info = {}, type = "item", slot = 3, },
			{ name = "weapon_flashlight", price = 875, amount = 100, info = {}, type = "item", slot = 4, },
			{ name = "goldpan", price = 345, amount = 100, info = {}, type = "item", slot = 5, },
			{ name = "pickaxe",	price = 785, amount = 100, info = {}, type = "item", slot = 6, },
			{ name = "miningdrill",	price = 7850, amount = 50, info = {}, type = "item", slot = 7, },
			{ name = "mininglaser",	price = 18250, amount = 5, info = {}, type = "item", slot = 8, },
			{ name = "drillbit", price = 750, amount = 100, info = {}, type = "item", slot = 9, },
		},
	},
}
Crafting = {
