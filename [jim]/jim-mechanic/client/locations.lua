...
Config.Locations = {
	...
	{	job = "mechanic",
		...
		stash = { { coords = vec4(-586.6889, -932.2383, 23.8866, 99.0555), w = 4.0, d = 1.0, }, },
		store = { { coords = vec4(-583.7275, -913.9769, 23.8867, 358.4997), w = 1.2, d = 0.25, }, },
		crafting = { { coords = vec4(-584.3154, -938.9869, 23.8866, 183.8344), w = 3.2, d = 1.0, }, },
		clockin = { { coords = vec4(-589.6641, -930.4695, 23.6899, 86.4843), prop = false }, },
		manualRepair = { { coords = vec4(-582.7903, -918.9794, 23.8866, 7.9365), prop = false, } },
		garage = { spawn = vec4(-541.2748, -913.0533, 23.4494, 60.9376),
					out = vec4(-540.8320, -916.9028, 23.8618, 62.0251),
					list = { "towtruck", "panto", "slamtruck", "cheburek", "utillitruck3" },
					prop = true },
		payments = { coords = vec4(-589.8397, -932.5407, 23.5886, 93.5756),
			img = "<center><p><img src=https://static.wikia.nocookie.net/gtawiki/images/f/f2/GTAV-LSCustoms-Logo.png width=150px></p>",
			prop = true, },
		blip = vec3(-578.0344, -923.9484, 23.8866),
		bliplabel = "RedLine Customs",
		blipcolor = 81,
		discordlink = "",
