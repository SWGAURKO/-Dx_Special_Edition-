...
Shared.GrowTime = 15 -- Time in minutes for a plant to grow from 0 to 100
...
Shared.PackageTime = 0 -- Time in minutes to wait for packaging
...
Shared.PayOut = {12500, 35800} -- Min/max payout for delivering a suspicious package
