...
Config.Minigame = 'ran-minigames' -- 'ox' or 'ran-minigames' if ran-minigames it will do a terminal like minigame, if ox it will be a circle minigame
...
Config.Price = {
    ['Stage 1'] = 12450, -- Price to buy the crypto miner
}
