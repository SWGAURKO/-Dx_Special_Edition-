...
const AddTeleportForm = ({
  ...
  const [newTeleport, setNewTeleport] = useState<JobTeleportProps>(
    {} as JobTeleportProps
  );
  ...
  function renderInputField(input: JobInputProps) {
    ...
    let currentTeleport: any = newTeleport;
  ...
  return (
    <form onSubmit={(event) => onAddTeleport(event, newTeleport)}>
...
export default AddTeleportForm;
