...
AK4Y.Languages = {
    ...
    ["descriptionText"] = "Earn some money by collecting trash.",
    ["earningsDescription"] = "You can earn some good money",
    ["profileDescription"] = "A little bit of dirty job won't be bad",
    ["earningInformation"] = "Money doesn't smell bad"
}
