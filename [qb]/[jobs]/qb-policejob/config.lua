...
Config.Locations = {
    ...
    ["duty"] = {
        [1] = vector3(441.85, -981.95, 30.88), -- LSPD
        [2] = vector3(837.23, -1289.14, 28.24), -- LAPD
        [3] = vector3(-447.5, 6013.20, 32.20), -- BCSO
        [4] = vector3(1829.45, 3682.20, 34.34), -- Sandy
        [5] = vector3(384.54, 800.13, 188.01), -- RangerPD
    },
    ["vehicle"] = {
        --[1] = vector4(441.41, -974.71, 25.7, 176.51), -- LSPD
        --[2] = vector4(380.18, -1620.35, 29.29, 229.84), -- DavisPD
        --[3] = vector4(-463.44, 6025.08, 31.34, 135.74), --BCSO
        --[4] = vector4(1856.23, 3687.56, 34.33, 301.62), -- Sandy
        --[5] = vector4(376.45, 793.45, 187.59, 89.33), -- RangerPD
    },
    ["vehspawn"] = { -- The numbers [1] must match the numbers in [vehicle]
        --[1] = vector4(442.24, -981.21, 25.7, 103.84), -- LSPD
        --[2] = vector4(384.33, -1624.99, 29.29, 320.09), -- DavisPD
        --[3] = vector4(-466.54, 6031.57, 31.34, 137.8), -- BCSO
        --[4] = vector4(1859.14, 3695.45, 33.8, 25.38), -- Sandy
        --[5] = vector4(374.42, 796.77, 187.28, 176.27), -- RangerPD
    },
    ["stash"] = {
        [1] = vector3(452.29, -999.92, 30.55), -- LSPD
        [2] = vector3(844.58, -1286.56, 28.24), -- LAPD
        [3] = vector3(-453.65, 5999.56, 37.01), -- BCSO
        [4] = vector3(1851.79, 3677.25, 38.65), -- Sandy
        [5] = vector3(387.94, 800.2, 191.04), -- RangerPD
    },
    ["impound"] = {
        [1] = vector3(471.84, -1001.63, 25.14), -- LSPD
        [2] = vector3(385.66, -1633.7, 29.29), -- DavisPD
        [3] = vector3(1819.22, 3679.64, 34.19), -- Sandy
    },
    ["helicopter"] = {
        [1] = vector4(460.24, -980.18, 43.69, 181.43), -- LSPD
        [2] = vector4(-462.15, 5994.77, 31.25, 134.84), -- BCSO
        [3] = vector4(1836.02, 3676.06, 38.93, 119.02), -- Sandy
    },
    ["helispawn"] = { -- The numbers [1] must match the numbers in [helicopter]
        [1] = vector4(449.16, -981.23, 43.69, 165.79), -- LSPD
        [2] = vector4(-475.18, 5988.43, 31.72, 317.27), -- BCSO
        [3] = vector4(1833.54, 3669.0, 38.93, 31.54), --Sandy
    },
    ["armory"] = {
        [1] = vector3(483.05, -999.61, 30.55), -- LSPD
        [2] = vector3(835.59, -1287.18, 28.24), -- LAPD
        [3] = vector3(-449.65, 6015.60, 37.0), -- BCSO
        [4] = vector3(1839.2, 3682.82, 38.70), -- Sandy
        [5] = vector3(387.57, 800.04, 187.96), -- RangerPD
    },
    ["trash"] = {
        [1] = vector3(450.1, -990.08, 30.58), -- LSPD
        [2] = vector3(372.83, -1592.63, 29.90), -- DavisPD
        [3] = vector3(1832.2, 3680.10, 34.33), -- Sandy
        [4] = vector3(-449.07, 6017.06, 32.38), -- Paleto
        [5] = vector3(383.62, 799.99, 187.32), -- RangerPD
    },
    ["fingerprint"] = {
        [1] = vector3(485.48, -989.28, 30.7), -- LSPD
        [2] = vector3(367.90, -1591.8, 25.45), -- DavisPD
        [3] = vector3(-452.4, 5997.24, 27.38), --BCSO
    },
    ["evidence"] = {
        [1] = vector3(473.25, -990.75, 26.15), -- LSPD
        [2] = vector3(849.53, -1310.74, 28.24), -- LAPD
        [3] = vector3(-440.2, 6012.1, 27.48), -- BCSO
        [4] = vector3(1854.58, 3678.52, 34.0), -- Sandy
    },
    ["labs"] = {
        [1] = vector3(483.49, -988.62, 31.06), -- LSPD
    },
    ["stations"] = {
        [1] = {label = "Los Santos Police Department", coords = vector4(428.23, -984.28, 29.76, 3.5), sprite= 60, scale= 0.8, colour= 0},
        [2] = {label = "La Mesa Police Station", coords = vector4(839.32, -1291.77, 28.24, 276.77), sprite= 60, scale= 0.8, colour= 0},
        [3] = {label = "San Andreas State Police", coords = vector4(1828.73, 3680.41, 34.33, 301.61), sprite= 60, scale= 0.8, colour= 0},
        -- [4] = {label = "San Andreas State Prison", coords = vector4(1845.903, 2585.873, 45.672, 272.249), sprite= 188, scale= 0.8, colour= 0}, -- Not used as pickle_prisons already has blips.
        [4] = {label = "Blaine County Sheriff's Office", coords = vector4(-448.26, 6007.83, 44.01, 225.93), sprite= 60, scale= 0.8, colour= 0},
        [5] = {label = "San Andreas State Park Rangers", coords = vector4(380.85, 795.76, 190.49, 159.28), sprite= 60, scale= 0.8, colour= 0},
        [6] = {label = "Los Santos Court", coords = vector4(233.86, -416.35, 48.1, 162.06), sprite= 537, scale= 0.7, colour= 0},
    },
}
