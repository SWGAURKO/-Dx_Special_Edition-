...
Config.Blocks2 = "6" -- Number of correct blocks the player needs to click
...
Config.CoolDown = 600 * 4000 --- Cooldown until can start next job default is 10 minutes you can use this link too get a better understanding of the time to change if you like http://convertwizard.com/600000-milliseconds-to-minutes

Config.SecurityPed = "s_m_m_armoured_02"

Config.Timer = 90 * 1000 -- Timer till the truck opens up and the guards come out (default is 3 minutes)
...
Config.Reward = "goldbar" -- Reward you get when finished looting the truck
...
Config.DeliveryReward = "goldbar" -- Reward you get when finished looting the truck
...
Config.GpsTimer = 50 * 1000 -- 3 minutes till you get a gps location to delivery the truck
...
Config.JobsList = {
    [1] = {
        ...
        event = "vrp-rahaauto:client:StartDelivery",
    ...
    [2] = {
        ...
        icon = "fas fa-truck-moving",
        busyicon = "fas fa-xmark",
        event = "vrp-rahaauto:client:GotAccess",
        minCops = 0,
    },
}
