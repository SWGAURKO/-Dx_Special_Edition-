...
local Server = {
    ...
    locations = {
        {model = 'u_m_m_streetart_01', coords = vec4(198.07, 2468.54, 55.91, 157.74), dict = 'timetable@ron@ig_3_couch', anim = 'base'},
        {model = 'a_m_m_hasjew_01', coords = vec4(196.84, 2463.68, 55.91, 20.68), scenario = 'WORLD_HUMAN_STAND_MOBILE', },
    }
}
