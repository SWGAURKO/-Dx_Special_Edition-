...
Config.PoliceJobs = { 'lspd', 'davispd','rangerpd', 'sandysheriff','paletosheriff' } -- Add your police job names here
...
Config.RegisterRewardItem = 'markedbills' -- The item that is rewarded upon a successful register robbery (Set to "markedbills" if using QBCore)
...
Config.SafeRewardItem = 'markedbills' -- The item that is rewarded upon a successful safe robbery (Set to "markedbills" if using QBCore)
