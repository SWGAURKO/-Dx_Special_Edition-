...
Config.RequiredItem = 'advancedlockpick' -- Item needed to rob the object
...
-- MINIGAME CONFIG -- 
Config.MinigameNumberofCircles = 8 -- Number of circles in the lockpick minigame
Config.MinigameMS = 5 -- Speed of the minigame (in milliseconds)

-- CASH REWARD CONFIG --
Config.CashChance = 100 -- This is a % out of 100 to receive cash
Config.MinReward = 20 -- Minimum Reward $
Config.MaxReward = 800 -- Maximum Reward $

-- COMMON ITEMS REWARD -- 
Config.CommonItemsChance = 85 -- This is a % out of 100 to receive an item from the CommonItems list
...
-- RARE ITEMS REWARD -- 
Config.RareItemsChance = 5 -- This is a % out of 100 to receive an item from the RareItems list
