...
Config.inventory = "ps-inventory" -- needed for fetching images
...
Config.items = {
    {item = "thermite", label = "Thermite", minStock = 5, maxStock = 5, price = 3250, image = "thermite.png"},
    {item = "laptop", label = "Laptop", minStock = 5, maxStock = 5, price = 8750, image = "laptop.png"},
    {item = "advancedlockpick", label = "Advanced Lockpick", minStock = 5, maxStock = 5, price = 2800, image = "advancedlockpick.png"},
    {item = "electronickit", label = "Electronic Kit", minStock = 5, maxStock = 5, price = 5600, image = "electronickit.png"},
    {item = "drill", label = "Drill", minStock = 5, maxStock = 5, price = 6800, image = "drill.png"},
    {item = "nitrous", label = "Nitrous", minStock = 5, maxStock = 5, price = 750, image = "nitrous.png"},
    {item = "weapon_revolver", label = "Revolver", minStock = 3, maxStock = 5, price = 9350, image = "weapon_revolver.png"},
    {item = "weapon_machinepistol", label = "Machine Pistol", minStock = 3, maxStock = 50, price = 7820, image = "weapon_machinepistol.png"},
    {item = "weapon_carbinerifle", label = "M14 Rifle", minStock = 3, maxStock = 5, price = 44200, image = "weapon_carbinerifle.png"},
    {item = "weapon_microsmg", label = "Micro SMG", minStock = 3, maxStock = 5, price = 12500, image = "weapon_microsmg.png"},
    {item = "weapon_sawnoffshotgun", label = "Sawn-off Shotgun", minStock = 3, maxStock = 17200, price = 40, image = "weapon_sawnoffshotgun.png"}, 
    {item = "weapon_assaultrifle", label = "Assault Rifle", minStock = 3, maxStock = 5, price = 28250, image = "weapon_assaultrifle.png"}, 
    {item = "weapon_bullupshotgun", label = "Bullup Shotgun", minStock = 3, maxStock = 5, price = 18200, image = "bullupshotgun.png"}, 
}
