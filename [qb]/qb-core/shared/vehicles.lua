...
local Vehicles = {
    ...
    { model = 'akumac', name = 'Akuma Classic', brand = 'Dinka', price = 83155, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'atlas', name = 'Atlas', brand = 'Karin', price = 60339, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'buffalo4h', name = 'Buffalo Hellfire', brand = 'Bravado', price = 140174, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'cheetahfel', name = 'Cheetah Veloce', brand = 'Grotti', price = 191828, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'coquette4c', name = 'Coquette D10 Widebody', brand = 'Invetero', price = 100584, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'dominatorgtc', name = 'Dominator GTC', brand = 'Vapid', price = 115910, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'elegant', name = 'Elegant', brand = 'Willard', price = 184411, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'eva', name = 'EVA', brand = 'Hijak', price = 134785, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'f620s2', name = 'F620 Sleeper', brand = 'Ocelot', price = 216006, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'gauntletstx', name = 'Gauntlet STX', brand = 'Bravado', price = 189784, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'gstyosemite1', name = 'Yosemite DRT', brand = 'Declasse', price = 177529, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'italigts', name = 'Itali GTS', brand = 'Grotti', price = 87538, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'kawaii', name = 'Kawaii', brand = 'Annis', price = 82378, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'meteor', name = 'Meteor', brand = 'Pfister', price = 80644, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'panorama', name = 'Panorama', brand = 'Classique', price = 115449, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'paradox2', name = 'Paradox', brand = 'Willard', price = 47136, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'peanut', name = 'Peanut', brand = 'Weeny', price = 10000, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'roxanne', name = 'Roxanne', brand = 'Annis', price = 172427, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'sheavas', name = 'Sheava', brand = 'Emperor', price = 51554, category = 'imports', type = 'automobile', shop = 'pdm' },  
    { model = 'spritzerdtm', name = 'Spritzer DTM', brand = 'Benefactor', price = 87323, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'stardust', name = 'Stardust', brand = 'Pfister', price = 72573, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'sunrise1', name = 'Sunrise R', brand = 'Maibatsu', price = 59060, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'vigout', name = 'Vigero Outlaw', brand = 'Declasse', price = 74216, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'vulture', name = 'Vulture', brand = 'Bravado', price = 89024, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'zion4', name = 'Zion Classic Custom', brand = 'Übermacht', price = 86000, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'zr380c', name = 'ZR-380', brand = 'Annis', price = 90000, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'zr380s', name = 'ZR-380 Custom', brand = 'Annis', price = 120000, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'gauntletc', name = 'Gauntlet Classic', brand = 'Bravado', price = 155969, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'gauntletstx', name = 'Gauntlet STX', brand = 'Bravado', price = 189784, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'glendalelimo', name = 'Glendale Stretch', brand = 'Benefactor', price = 104695, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'gstyosemite1', name = 'Yosemite DRT', brand = 'Declasse', price = 177529, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'hotwee', name = 'Hotring Weevil', brand = 'BF', price = 89853, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'kampfer', name = 'Kampfer', brand = 'Übermacht', price = 59955, category = 'imports', type = 'automobile', shop = 'pdm' },
    { model = 'meteor', name = 'Meteor', brand = 'Pfister', price = 80644, category = 'imports', type = 'automobile', shop = 'pdm' },
  }
