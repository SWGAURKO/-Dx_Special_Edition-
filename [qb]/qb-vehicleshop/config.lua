...
Config.Shops = {
    ...
    ['luxury'] = {
        ...
        ['Zone'] = {
            ['Shape'] = {
                vector2(-595.59521484375, -909.91644287109),
                vector2(-606.74346923828, -918.9462890625),
                vector2(-607.90252685547, -923.61108398438),
                vector2(-597.81292724609, -937.27014160156),
                vector2(-590.00543212891, -938.61499023438),
                vector2(-578.58551025391, -924.46453857422)
            },
            ['minZ'] = 17.0,
            ['maxZ'] = 18.0,
            ['size'] = 2.75 -- size of the vehicles zones
        ...
        ['ShopLabel'] = 'RedLine Vehicle Shop',
        ['showBlip'] = true, -- true or false
        ['blipSprite'] = 326, -- Blip sprite
        ['blipColor'] = 1, -- Blip color
        ['TestDriveTimeLimit'] = 3.5,
        ['Location'] = vector3(-592.4890, -925.3112, 17.3601),
        ['ReturnLocation'] = vector3(-578.2157, -881.9681, 16.9599),
        ['VehicleSpawn'] = vector4(-578.2157, -881.9681, 16.9599, 270.0375),
        ['TestDriveSpawn'] = vector4(-578.2157, -881.9681, 16.9599, 270.0375), -- Spawn location for test drive
        ['ShowroomVehicles'] = {
            [1] = {
                coords = vector4(-593.3792, -932.3918, 16.5840, 1.9355),
                defaultVehicle = 'visione',
                chosenVehicle = 'visione'
            },
            [2] = {
                coords = vector4(-585.0313, -922.6848, 16.5840, 38.8492),
                defaultVehicle = 'prototipo',
                chosenVehicle = 'prototipo'
            },
            [3] = {
                coords = vector4(-602.3479, -922.2513, 16.5840, 312.2737),
