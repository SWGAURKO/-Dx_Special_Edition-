local isDead = false
RegisterNetEvent('Dx-deathscreen:openUI', function(time)
    isDead = true
...
RegisterNetEvent('Dx-deathscreen:revive', function()
    isDead = false
...
RegisterNetEvent('Dx-deathscreen:die', function(time)
    isDead = true
    SendNUIMessage({action = "DSMenu", open = true, time = time})
    if Config.Blur then
        TriggerScreenblurFadeIn()
...
RegisterNetEvent('Dx-deathscreen:res', function()
    SendNUIMessage({action = "res"})
end)

RegisterNetEvent('Dx-deathscreen:updateRes', function(time)
